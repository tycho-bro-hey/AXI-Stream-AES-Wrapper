...
REM
REM Generated by Vivado on Thu Apr 02 09:49:56 -0400 2026
...
echo "xvlog --incr --relax -prj tb_aes_gcm_core_adapter_vlog.prj"
call xvlog  --incr --relax -prj tb_aes_gcm_core_adapter_vlog.prj -log xvlog.log
