...
#
# Script generated by Vivado on Thu Apr 02 14:31:52 -0400 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : aes_gcm_256_axis_top.sh
...
#
# Usage        : aes_gcm_256_axis_top.sh
#                aes_gcm_256_axis_top.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                aes_gcm_256_axis_top.sh [-rerun]
#                aes_gcm_256_axis_top.sh [-reset_run]
#                aes_gcm_256_axis_top.sh [-clean]
#                aes_gcm_256_axis_top.sh [-reset_log]
#                aes_gcm_256_axis_top.sh [-help]
#
...
# script info
echo -e "aes_gcm_256_axis_top.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./aes_gcm_256_axis_top.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L axis_infrastructure_v1_1_1 -L axis_register_slice_v1_1_35 -L axis_dwidth_converter_v1_1_34 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot aes_gcm_256_axis_top xil_defaultlib.aes_gcm_256_axis_top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim aes_gcm_256_axis_top -key {Behavioral:sim_1:Functional:aes_gcm_256_axis_top} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb aes_gcm_256_axis_top.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./aes_gcm_256_axis_top.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: aes_gcm_256_axis_top.sh [-help]\n\
Usage: aes_gcm_256_axis_top.sh [-step]\n\
Usage: aes_gcm_256_axis_top.sh [-lib_map_path]\n\
Usage: aes_gcm_256_axis_top.sh [-rerun]\n\
Usage: aes_gcm_256_axis_top.sh [-reset_run]\n\
Usage: aes_gcm_256_axis_top.sh [-clean]\n\
Usage: aes_gcm_256_axis_top.sh [-reset_log]\n\
Usage: aes_gcm_256_axis_top.sh [-keep_index]\n\
Usage: aes_gcm_256_axis_top.sh [-noclean_files]\n\n\
