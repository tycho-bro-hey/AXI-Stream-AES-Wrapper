...
REM
REM Generated by Vivado on Thu Apr 02 12:02:53 -0400 2026
...
echo "xvlog --incr --relax -prj tb_tx_header_bridge_vlog.prj"
call xvlog  --incr --relax -prj tb_tx_header_bridge_vlog.prj -log xvlog.log
