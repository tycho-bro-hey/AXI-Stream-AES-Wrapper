...
REM
REM Generated by Vivado on Thu Apr 02 12:24:53 -0400 2026
...
echo "xvlog --incr --relax -prj tb_key_iv_loaders_vlog.prj"
call xvlog  --incr --relax -prj tb_key_iv_loaders_vlog.prj -log xvlog.log
