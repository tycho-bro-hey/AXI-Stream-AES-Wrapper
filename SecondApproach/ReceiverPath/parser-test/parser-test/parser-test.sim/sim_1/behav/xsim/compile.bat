...
REM
REM Generated by Vivado on Fri Apr 03 09:26:44 -0400 2026
...
echo "xvlog --incr --relax -prj tb_rx_stream_parser_vlog.prj"
call xvlog  --incr --relax -prj tb_rx_stream_parser_vlog.prj -log xvlog.log
