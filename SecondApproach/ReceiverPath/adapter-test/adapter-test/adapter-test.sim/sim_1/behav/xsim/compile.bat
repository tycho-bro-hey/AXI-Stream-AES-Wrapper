...
REM
REM Generated by Vivado on Fri Apr 03 09:39:23 -0400 2026
...
echo "xvlog --incr --relax -prj tb_aes_gcm_core_adapter_decrypt_vlog.prj"
call xvlog  --incr --relax -prj tb_aes_gcm_core_adapter_decrypt_vlog.prj -log xvlog.log
