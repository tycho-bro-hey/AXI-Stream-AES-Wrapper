...
#
# Script generated by Vivado on Fri Apr 03 10:35:19 -0400 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : exdes_tb.sh
...
#
# Usage        : exdes_tb.sh
#                exdes_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                exdes_tb.sh [-rerun]
#                exdes_tb.sh [-reset_run]
#                exdes_tb.sh [-clean]
#                exdes_tb.sh [-reset_log]
#                exdes_tb.sh [-help]
#
...
# script info
echo -e "exdes_tb.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./exdes_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axis_infrastructure_v1_1_1 -L axis_data_fifo_v2_0_17 -L proc_sys_reset_v5_0_17 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot exdes_tb xil_defaultlib.exdes_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim exdes_tb -key {Behavioral:sim_1:Functional:exdes_tb} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb exdes_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./exdes_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: exdes_tb.sh [-help]\n\
Usage: exdes_tb.sh [-step]\n\
Usage: exdes_tb.sh [-lib_map_path]\n\
Usage: exdes_tb.sh [-rerun]\n\
Usage: exdes_tb.sh [-reset_run]\n\
Usage: exdes_tb.sh [-clean]\n\
Usage: exdes_tb.sh [-reset_log]\n\
Usage: exdes_tb.sh [-keep_index]\n\
Usage: exdes_tb.sh [-noclean_files]\n\n\
