...
REM
REM Generated by Vivado on Fri Apr 03 10:41:42 -0400 2026
...
echo "xvlog --incr --relax -prj tb_aes_gcm_256_axis_decrypt_top_vlog.prj"
call xvlog  --incr --relax -prj tb_aes_gcm_256_axis_decrypt_top_vlog.prj -log xvlog.log
