...
HD_PWD='C:/Users/Robert Stacy Lois II/Desktop/aes-256-gcm/wrapper2/receiver/top-test/top-test/top-test.runs/axis_pt_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_pt_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_pt_fifo.tcl
