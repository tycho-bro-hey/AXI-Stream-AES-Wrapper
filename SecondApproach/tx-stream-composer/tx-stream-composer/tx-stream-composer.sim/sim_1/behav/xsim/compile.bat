...
REM
REM Generated by Vivado on Thu Apr 02 10:40:13 -0400 2026
...
echo "xvlog --incr --relax -prj tb_tx_stream_composer_vlog.prj"
call xvlog  --incr --relax -prj tb_tx_stream_composer_vlog.prj -log xvlog.log
