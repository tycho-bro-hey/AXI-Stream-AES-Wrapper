...
HD_PWD='C:/Users/Robert Stacy Lois II/Desktop/aes-256-gcm/wrapper2/top-level-test/top-level-test/top-level-test.runs/axis_upsizer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_upsizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_upsizer.tcl
